...
<div className="border rounded-lg px-6 py-4 mb-6 bg-muted/30">
        ...
        <div className="border rounded-lg px-6 py-4 mb-6 bg-muted/30">
          ...
          <p>
            Did you know that you can<strong> almost</strong> fit all the
            planets in the solar system between the Earth and the Moon by
            putting them next to each other without any space between them?
          </p>
          <p style={{ fontWeight: "bold" }}>Wait, how?</p>
          <p>It is actually pretty simple elemantary school mathematics.</p>
          ...
          <p style={{ fontWeight: "bold" }}>Average Lunar Distance:</p>
          <div className="border rounded-lg p-4 my-4 bg-muted/50 overflow-x-auto">
            <BlockMath math="384,399 \text{ km}" />
          </div>
          <p>
            Therefore, all the planets in solar system can{" "}
            <strong> almost</strong> fit in the space between Earth and the
            Moon.
          </p>

          <p>
            <strong>A nice note:</strong> If you line the planets up
            top-to-bottom (pole-to-pole), they fit with plenty of room to spare!
          </p>
        </div>
        <div className="border rounded-lg px-6 py-4 mb-6 bg-muted/30">
          <h2 style={{ marginTop: 0 }}>February 11, 2026</h2>
          <p>
            Did you know that in 2014, a radar data processing system used by
            the regional air traffic control facility serving Southern
            California failed after running continuously for an extended period?
            The failure caused hundreds of flights to be delayed by 1 to 3
            hours, and some were even canceled. Later, it was revealed that the
            failure happened because of a very small software bug involving a
          ...
          <p>
            Computers store numbers in binary. Most older computers were/are
            still using 32-bit systems. That means that the biggest number a
            32-bit unsigned integer can store is a binary value with 32 1's next
            to each other. That number is:
          </p>
          <div className="border rounded-lg p-4 my-4 bg-muted/50 overflow-x-auto">
            <BlockMath math="2^{32} - 1 = 4,294,967,295" />
          </div>
          <p>
            However, computers need to store negative numbers as well. So,
            computer scientists in the 1960s came up with a solution. Using the
            most significant bit to store the sign. If it is 0, that is a
            positive number; if it is 1, that is a negative number. This is
            called a 32-bit signed integer. To be able to read a negative
            number, you have to invert all the bits and add 1.
          </p>
          ...
          <p>
            Therefore, we can now represent negative numbers, with a small
            caveat. The biggest positive number we can go up to now is 31 1's
            next to each other. So, our range became:
          </p>
          <div className="border rounded-lg p-4 my-4 bg-muted/50 overflow-x-auto">
            <BlockMath math="-2,147,483,648 \text{ to } 2,147,483,647" />
          </div>
          <p>
            An integer overflow happens when a number exceeds the maximum value
            the data type can store. Which basically means that a 32-bit signed
            integer cannot exceed <InlineMath math="2,147,483,647" />.
          </p>
          <p>
            After the investigation, authorities found that the system was
            keeping track of time using a 32-bit signed integer, counting
            milliseconds. Which means the system was going to crash after:
          </p>
          <div className="border rounded-lg p-4 my-4 bg-muted/50 overflow-x-auto">
            <BlockMath math="2,147,483,647 \text{ ms} \approx 24.85 \text{ days}" />
          </div>
          <p>
            They knew about this, but their solution was basically restarting
            the system. However, this time they forgot. This was a good lesson
            for those programmers not to keep track of time using a 32-bit
            signed integer.
          </p>
          <p>
            A nice note: A 64-bit signed integer can run for{" "}
            <InlineMath math="292" /> million years (counting milliseconds)
            without crashing.
          </p>
          <div className="border rounded-lg p-4 my-4 bg-muted/50 overflow-x-auto">
